...
# Modified code from https://github.com/Harry24k/adversarial-attacks-pytorch 
# Authored by Harry Kim under an MIT License
# The main modification is to make it work with varying attack parameters at inference time
# Check out our paper for more info on the modifications
